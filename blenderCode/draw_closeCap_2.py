...
isCertain = {i:False for i in range(1,19)}
isCertain[1] = True
...
all_verts[PName_idx[16]].co[0] = all_verts[PName_idx[1]].co[0]
isCertain[16] = True

all_verts[PName_idx[17]].co = all_verts[PName_idx[1]].co.copy()
all_verts[PName_idx[17]].co[1] += y_2_22
isCertain[17] = True

all_verts[PName_idx[18]].co = all_verts[PName_idx[2]].co.copy()
all_verts[PName_idx[18]].co[1] += y_2_22
isCertain[18] = True
