...
all_verts[PName_idx[19]].co[1] -= data[cap_name]['b1']
isCertain[19] = True

all_verts[PName_idx[20]].co = all_verts[PName_idx[17]].co.copy()
all_verts[PName_idx[20]].co[1] -= data[cap_name]['b2']
isCertain[20] = True
